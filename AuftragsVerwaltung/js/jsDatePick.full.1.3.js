...
g_l = [];
g_l["MONTHS"] = ["Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"];
g_l["DAYS_3"] = ["So","Mo","Di","Mi","Do","Fr","Sa"];
g_l["MONTH_BCK"] = "Vorheriger Monat";
g_l["MONTH_FWD"] = "Nächster Monat";
g_l["YEAR_BCK"] = "Vorheriges Jahr";
g_l["YEAR_FWD"] = "Nächstes Jahr";
g_l["CLOSE"] = "Abbrechen";
	...
	if (this.oConfiguration.useMode == 2){
		if (this.oConfiguration.target != false){
			if (typeof(JsgetElem(this.oConfiguration.target)) != null){
				...
				//inputElement.onmouseover = function(){ JsDatePick.getCalInstanceById(this.getAttribute("globalNumber")).showCalendar(); };
...
JsDatePick.prototype.populateMainBox = function(aMainBox){
	var d = document,aDayDiv,aTextNode,columnNumber = 1,disabledDayFlag = false,cmpMonth = this.currentMonth-1,oDay,iStamp,skipDays,i;
