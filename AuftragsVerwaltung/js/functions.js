...
function saveOverviewEdit(id){
	...
	var params=p("nummer_datum")+"&id="+id+"&"+p("nummer_strasse")+"&"+p("nummer_plz")+"&"+p("nummer_ort")+"&"+p("nummer_auftraggeber")+"&"+p("nummer_status")+"&"+p("nummer_nummer")+"&"+p("nummer_zusatz")+"&"+p("nummer_notes");
