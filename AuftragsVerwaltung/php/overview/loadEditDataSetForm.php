...
$sql="SELECT datum, strasse, plz, ort, auftraggeber, status, nummer, adresszusatz, notizen, login FROM auftraege WHERE id=".$id;
...
$output .= "		<td>".html_createInputSelect("nummer_login", $db,"uid","uid","logins",$row["login"])."</td>";
$output .= "	</tr>";
$output .= "	<tr>";
$output .= "		<td>Datum</td>";
