...
$output .= "					<td>".html_createInputSelect("nummer_auftraggeber",$db, "id","firma","auftraggeber")."</td>";
$output .= "				</tr>";
$output .= "				<tr>";
$output .= "					<td>".html_createRadioButton("nummer_rb", "rb_above")."</td>";
$output .= "					<td>Neu mit Werten von Oben + Firma: ".html_createInputText("ag_firma")."</td>";
$output .= "				</tr>";
$output .= "				<tr>";
