...
$output .= "					<td class=\"boxed\">".html_createInputSelect("nummer_auftraggeber",$db, "id","firma","auftraggeber")."</td>";
$output .= "				</tr>";
$output .= "				<tr>";
$output .= "					<td>".html_createRadioButton("nummer_rb", "rb_above")."</td>";
$output .= "					<td class=\"boxed inactive\">Neu mit Werten von Oben + Firma: ".html_createInputText("ag_firma")."</td>";
$output .= "				</tr>";
$output .= "				<tr>";
$output .= "					<td>".html_createRadioButton("nummer_rb", "rb_new")."</td>";
$output .= "					<td class=\"boxed inactive\">";
$output .= "						<table>	";		
$output .= "							<tr>	";
$output .= "								<td>Firma</td>";
